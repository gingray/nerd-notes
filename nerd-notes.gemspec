...
require "nerd/notes/version"

Gem::Specification.new do |spec|
  spec.name          = "nerd-notes"
  spec.license       = "MIT"
  spec.version       = Nerd::Notes::VERSION
  spec.authors       = ["gingray"]
  spec.email         = ["gingray.dev@gmail.com"]

  spec.summary       = %q{Tool to create nerd notes}
  spec.description   = %q{Create nerd notes}
  spec.homepage      = "https://github.com/gingray/nerd-notes"
  ...
  if spec.respond_to?(:metadata)
    ...
    spec.metadata["source_code_uri"] = "https://github.com/gingray/nerd-notes"
    spec.metadata["changelog_uri"] = "https://github.com/gingray/nerd-notes/CHANGELOG.md"
  else
